...
function downloadList() {
	...
	let ListDownload = function () {
		if (number >= length) {
			...
			// 同步下载模式
			if (window.outter.state.downloadMode == "2" && stillNeedDownloadlist.length) {
						...
						<div className='left'>
							...
							<div className='next-cate-header-badge'>
								<div>
									...
									<p className='source'>
										<img src='https://static.ouorz.com/QQ20200114-203749@2x.png' /> A
										Levels
									</p>
								</div>
								<div>
						...
						<div className='next-paper-header-info'>
									...
									content={
										<div>
											<p style={{ marginBottom: "5px" }}>
												<Button
													type={
														this.state.downloadMode == "1" || !this.state.downloadMode
															? "primary"
															: ""
													}
													onClick={() => {
							...
							>
								<div className='next-paper-download-info'>
									...
									<p>
										Please keep this page open until the download process is complete
									</p>
								</div>
								<Progress
