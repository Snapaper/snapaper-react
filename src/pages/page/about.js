            ...
            <div>
              ...
              <p>
                ...
                <b>
                  ...
                  (https://www.savemyexams.co.uk) or Xtremepapers
                  (https://www.xtremepapers.com)
                </b>
              </p>
              <br />
              ...
              <p>
                ...
                (https://www.savemyexams.co.uk) or Xtremepapers
                (https://www.xtremepapers.com). All requests are obtained from
                the GCE Guide (http://www.gceguide.com) or SaveMyExams
                (https://www.savemyexams.co.uk) or Xtremepapers
                (https://www.xtremepapers.com) website. All the content has not
                been changed or downloaded. This website is based on the GCE
                Guide (http://www.gceguide.com) or SaveMyExams
                (https://www.savemyexams.co.uk) or Xtremepapers
                (https://www.xtremepapers.com) to provide a convenient download
              ...
              <p>
                ...
                <br />
                <iframe
                  src="https://ghbtns.com/github-btn.html?user=HelipengTony&repo=snapaper&type=star&count=true&size=large"
                  frameborder="0"
                  scrolling="0"
                  width="160px"
                  height="30px"
                ></iframe>
                <iframe
                  src="https://ghbtns.com/github-btn.html?user=HelipengTony&repo=snapaper&type=watch&count=true&size=large&v=2"
                  frameborder="0"
                  scrolling="0"
                  width="160px"
                  height="30px"
                ></iframe>
                <iframe
                  src="https://ghbtns.com/github-btn.html?user=HelipengTony&repo=snapaper&type=fork&count=true&size=large"
                  frameborder="0"
                  scrolling="0"
                  width="158px"
                  height="30px"
                ></iframe>
                <iframe
                  src="https://ghbtns.com/github-btn.html?user=HelipengTony&type=follow&count=true&size=large"
                  frameborder="0"
                  scrolling="0"
                  width="220px"
                  height="30px"
              ...
              <p>
                ...
                <br />
                2. Fixed a bug where 「Back」 button could not be used under
                some browsers
                <br />
                <br />
                <b>V0.13</b>
                <br />
                1. Fixed a bug where the past papers were not found in some
                subjects
                <br />
                ...
                <br />
                2. Added "Back to Top" and "Back to Bottom" buttons on papers
                page
                <br />
                3. Added a notification page for maintenance
                <br />
                4. Added a toolbar to count the number of test papers that have
                been added to the list on papers page
                <br />
                <br />
                <b>V0.151</b>
                <br />
